...
namespace MedicalManagementSystem.Application.Services.Auth
{
    public class AuthService(AppDbContext db, IMapper mapper, UserManager<User> userManager, RoleManager<IdentityRole> roleManager, IOptions<JWT> jwt, IHttpContextAccessor httpContextAccessor) : IAuthService
    {
        ...
        public async Task<IEnumerable<UserDto>> GetAllUsersAsync()
        {
            ...
            return users.Select(u => new UserDto
            {
                Email = u.Email,
                UserName = u.UserName,
                Image = $"{GetHostUrl()}/{Files.masterFolderName}/Users/{u.ImageUrl}",
            });
        }
        ...
        public async Task<UserDto> GetUserByIdAsync(string id)
        {
            ...
            return new UserDto
            {
                ...
                Image = $"{GetHostUrl()}/{Files.masterFolderName}/Users/{user.ImageUrl}",
            };
        }
...
#pragma warning restore SYSLIB0023 // Type or member is obsolete
        ...
        public async Task<AuthModel> LoginAsync(LoginDto loginDto)
        {
            ...
            authModel.ImageUrl = $"{GetHostUrl()}/{Files.masterFolderName}/Users/{user.ImageUrl}";
        ...
        public async Task<AuthModel> RegisterAsync(RegisterDto model)
        {
            ...
            var authModel = new AuthModel()
            {
                ...
                Username = user.UserName,
                ImageUrl = $"{GetHostUrl()}/{Files.masterFolderName}/Users/{user.ImageUrl}"
            };
            return authModel;
        }
